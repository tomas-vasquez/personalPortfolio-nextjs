var Framer = {
  ...
  drawTick: function (x1, y1, x2, y2) {
    ...
    gradient.addColorStop(0, style.getPropertyValue("--green"));
    gradient.addColorStop(0.6, style.getPropertyValue("--green"));
  ...
  drawEdging: function () {
    ...
    this.context.beginPath();
    var style = getComputedStyle(document.body);
    this.context.strokeStyle = style.getPropertyValue("--green");
    this.context.lineWidth = 1;
...
var Scene = {
  ...
  canvasConfigure: function () {
    ...
    this.context.strokeStyle = "var(--green)";
    this.calculateSize();
  },
...
var Controls = {
  ...
  drawPic: function () {
    ...
    this.context.beginPath();
    var style = getComputedStyle(document.body);
    this.context.fillStyle = style.getPropertyValue("--green");
    this.context.lineWidth = 1;

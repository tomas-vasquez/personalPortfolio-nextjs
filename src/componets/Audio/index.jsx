...
class Audio extends Component {
  ...
  preLoadCompleteSong() {
    ...
    const { audioStreamData, audioLoadOffsetTime, audioContextCreatedTime } =
      this.state;
  ...
  trackerIsInsideOfSmallCircle(event) {
    const { canvasCx, canvasCy, canvasCoord, sceneRadius, trackerInnerDelta } =
      this.state;
  ...
  getSongName() {
    ...
    if (tracks[musicIndex]) {
      return tracks[musicIndex].song || "No Music Name Found";
    }
  }
  getSongArtist() {
    const { tracks, musicIndex } = this.state;
        ...
        >
          <div className="Player">
            <canvas
              id="Player-canvas"
              style={{
                transform: "scale(" + this.state.canvaScale + ")",
              }}
            ></canvas>
